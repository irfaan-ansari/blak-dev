...
import {
  ...
  ComboboxTrigger,
  ComboboxValue,
} from "@blak/ui/components/combobox"
import { Input } from "@blak/ui/components/input"
import { ScrollArea } from "@blak/ui/components/scroll-area"
  ...
  return (
    ...
    >
      <BasePhoneInput.default
        className={cn(
          "flex rounded-md border border-transparent transition has-[[data-slot=input]:focus-visible]:border-ring has-[[data-slot=input]:focus-visible]:ring-3 has-[[data-slot=input]:focus-visible]:ring-ring/50",
          props["aria-invalid"] &&
      ...
      <ComboboxTrigger
        render={
          <Button
            ...
            size={variant}
            className={cn(
              "flex gap-1 rounded-s-md rounded-e-none border-e-0 border-none bg-input px-2.5 py-0 leading-none hover:bg-secondary focus:z-10 data-pressed:bg-secondary",
              disabled && "opacity-50"
            )}
            disabled={disabled}
          >
